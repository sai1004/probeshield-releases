...
## Installing ProbeShield via APK (Sideload)

This guide walks you through installing ProbeShield on any Android 8.0+ device.
...
5. Select **Chrome** (or whichever browser you used to download)
...
4. Tap the back button to return to the install prompt
...
On first launch ProbeShield will request:

- **Location** — Required by Android to scan WiFi networks. We do not track your location.
- **Nearby devices** (Android 12+) — Required for network discovery.
...
Go to **Settings → Apps → ProbeShield → Uninstall**.
...
📧 [support@probeshield.com](mailto:support@probeshield.com)
🌐 [probeshield.com](https://probeshield.com)
