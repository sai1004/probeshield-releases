...
**Initial release of ProbeShield.**

- 🔍 Device discovery (ARP + mDNS + ping)
- 🔌 TCP port scanner (top 100 ports)
- 🏷️ MAC OUI manufacturer lookup
- ⚠️ Risk scoring (Critical / High / Medium / Safe)
- 📜 Local scan history
